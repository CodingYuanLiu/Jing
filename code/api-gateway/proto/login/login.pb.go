...
func init() {
	proto.RegisterType((*AccessResp)(nil), "go.micro.srv.auth-service.AccessResp")
	proto.RegisterType((*CodeReq)(nil), "go.micro.srv.auth-service.CodeReq")
	proto.RegisterType((*AuthReq)(nil), "go.micro.srv.auth-service.AuthReq")
	proto.RegisterType((*AuthResp)(nil), "go.micro.srv.auth-service.AuthResp")
	proto.RegisterType((*LJReq)(nil), "go.micro.srv.auth-service.LJReq")
	proto.RegisterType((*TokenResp)(nil), "go.micro.srv.auth-service.TokenResp")
	proto.RegisterType((*UPReq)(nil), "go.micro.srv.auth-service.UPReq")
}

func init() { proto.RegisterFile("auth-service.proto", fileDescriptor_67c21677aa7f4e4f) }
